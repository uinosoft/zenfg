...
```powershell
node examples/babylon-interop/tests/gpu/run.mjs
```
...
```powershell
$env:PLAYGROUND_URL = 'http://127.0.0.1:4175/playground/'
node examples/babylon-interop/tests/gpu/playground.mjs
```
