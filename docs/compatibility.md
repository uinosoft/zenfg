...
| --- | --- | --- | --- |
| `@zenfg/webgpu` | `0.1.0-beta.3` | Node 24 for tooling; native WebGPU at runtime | produces 1.1 |
| `@zenfg/snapshot` | `0.1.0-beta.3` | ESM, ES2022 | reads Legacy V0, Legacy Candidate V1, ZenFG 1.1 |
| `@zenfg/inspector` | `0.1.0-beta.3` | modern DOM; no WebGPU dependency | reads through `@zenfg/snapshot` |
| `zenfg` | `0.1.0-beta.3` | Rust 1.98; wgpu 30 | optional producer through `snapshot` |
| `zenfg-snapshot` | `0.1.0-beta.3` | Rust 1.98; no wgpu | reads Legacy V0, Legacy Candidate V1, ZenFG 1.1 |
