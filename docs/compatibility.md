...
| `@zenfg/snapshot` | `0.1.x` | ESM, ES2022 | reads Legacy V0, t3d V1 candidate, ZenFG 1.0 |
...
| `zenfg-snapshot` | `0.1.x` | Rust 1.98; no wgpu | reads Legacy V0, t3d V1 candidate, ZenFG 1.0 |
