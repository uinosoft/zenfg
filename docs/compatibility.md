...
| --- | --- | --- | --- |
| `@zenfg/webgpu` | `0.1.0-beta.2` | Node 24 for tooling; native WebGPU at runtime | produces 1.1 |
| `@zenfg/snapshot` | `0.1.0-beta.2` | ESM, ES2022 | reads Legacy V0, Legacy Candidate V1, ZenFG 1.1 |
...
| `zenfg-snapshot` | `0.1.0-beta.2` | Rust 1.98; no wgpu | reads Legacy V0, Legacy Candidate V1, ZenFG 1.1 |
