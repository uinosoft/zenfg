    ...
    sourceFiles: [
        {
            ...
            path: 'apps/site/examples/particles4all-framegraph/src/main.ts',
        ...
        ...sourceFiles, {
            ...
            path: 'apps/site/playground/src/catalog/particles4All.ts', role: 'host', language: 'typescript',
            loadSource: async () => (await import('./particles4All.ts?raw')).default,
        }],
    async mount(context) {
        const [{ startParticles4All }, { Pane }] = await Promise.all([
            import('../../../examples/particles4all-framegraph/src/index.ts'), import('tweakpane'),
        ]);
