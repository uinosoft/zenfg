...
export const referenceRendererExample: PlaygroundExampleDefinition = {
    ...
    readyState: 'live',
    description: "Render an instanced 3D scene with culling and selectable depth conventions. Explore how the reference renderer records scene rendering and presentation into a FrameGraph. Drag to orbit · Scroll to zoom.",
    hasControls: true,
    entrySourceId: 'reference-renderer-entry',
    sourceFiles: [
        {
            id: 'reference-renderer-entry', label: 'main.ts', role: 'example', language: 'typescript',
            path: 'apps/site/examples/reference-renderer-demo/src/main.ts',
        ...
        },
        {
            ...
            path: 'apps/site/examples/reference-renderer/src/renderer.ts',
        ...
        },
        {
            ...
            path: 'apps/site/examples/reference-renderer/src/types.ts',
        ...
        },
        {
            ...
            path: 'apps/site/examples/reference-renderer/src/primitives.ts',
        ...
        },
        {
            ...
            path: 'apps/site/examples/reference-renderer-demo/src/scene.ts',
        ...
        },
        {
            ...
            path: 'apps/site/examples/reference-renderer-demo/src/camera.ts',
        ...
        },
        {
            ...
            path: 'apps/site/examples/reference-renderer-demo/src/present.ts',
        ...
        },
        {
            ...
            path: 'apps/site/examples/reference-renderer/src/shaders.ts',
        ...
        },
        {
            ...
            path: 'apps/site/examples/reference-renderer-demo/src/host.ts',
        ...
        },
        {
            ...
            path: 'apps/site/playground/src/catalog/referenceRenderer.ts',
            loadSource: async () => (await import('./referenceRenderer.ts?raw')).default,
        },
    ],
    async mount(context) {
        const [{ startReferenceRenderer }, { Pane }] = await Promise.all([
            import('../../../examples/reference-renderer-demo/src/index.ts'), import('tweakpane'),
        ]);
