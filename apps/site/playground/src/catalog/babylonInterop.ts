    ...
    sourceFiles: [
        {
            ...
            path: 'apps/site/examples/babylon-interop/src/main.ts',
        ...
        },
        {
            ...
            path: 'apps/site/examples/babylon-interop/src/graph.ts',
        ...
        },
        {
            ...
            path: 'apps/site/examples/babylon-interop/src/bridge.ts',
        ...
        },
        {
            ...
            path: 'apps/site/examples/babylon-interop/src/resolve.ts',
        ...
        },
        {
            ...
            path: 'apps/site/examples/babylon-interop/src/scene.ts',
        ...
        },
        {
            ...
            path: 'apps/site/examples/babylon-interop/src/present.ts',
        ...
        },
        {
            ...
            path: 'apps/site/examples/babylon-interop/src/host.ts',
        ...
        },
        {
            ...
            path: 'apps/site/playground/src/catalog/babylonInterop.ts',
            loadSource: async () => (await import('./babylonInterop.ts?raw')).default,
        },
    ],
    async mount(context) {
        const [{ startBabylonInterop }, { Pane }] = await Promise.all([
            import('../../../examples/babylon-interop/src/index.ts'), import('tweakpane'),
        ]);
