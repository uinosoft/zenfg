    ...
    sourceFiles: [
        {
            ...
            path: 'apps/site/examples/three-interop/src/main.ts',
        ...
        },
        {
            ...
            path: 'apps/site/examples/three-interop/src/graph.ts',
        ...
        },
        {
            ...
            path: 'apps/site/examples/three-interop/src/bridge.ts',
        ...
        },
        {
            ...
            path: 'apps/site/examples/three-interop/src/scene.ts',
        ...
        },
        {
            ...
            path: 'apps/site/examples/three-interop/src/present.ts',
        ...
        },
        {
            ...
            path: 'apps/site/examples/three-interop/src/host.ts',
        ...
        },
        {
            ...
            path: 'apps/site/playground/src/catalog/threeInterop.ts',
            loadSource: async () => (await import('./threeInterop.ts?raw')).default,
        },
    ],
    async mount(context) {
        const [{ startThreeInterop }, { Pane }] = await Promise.all([
            import('../../../examples/three-interop/src/index.ts'), import('tweakpane'),
        ]);
