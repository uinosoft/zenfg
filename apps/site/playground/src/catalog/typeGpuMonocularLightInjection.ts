...
export const typeGpuMonocularLightInjectionExample: PlaygroundExampleDefinition = {
    ...
    readyState: 'live',
    references: [{ relation: 'Adapted from', label: "TypeGPU · Monocular Light Injection", href: "https://github.com/software-mansion/TypeGPU/tree/2adbc1b3636f2c7c1be00d242171e23c85c73898/apps/typegpu-docs/src/examples/image-processing/monocular-light-injection" }],
    description: "Estimate depth from an image and add an interactive light with TypeGPU. Inspect the dependency between depth inference and relighting, and how cached depth is reused. Move or drag the light · Scroll to change distance.",
    ...
    sourceFiles: [
        {
            ...
            path: 'apps/site/examples/typegpu-monocular-light-injection/src/main.ts',
        ...
        ...sourceFiles, {
            ...
            path: 'apps/site/playground/src/catalog/typeGpuMonocularLightInjection.ts', role: 'host', language: 'typescript',
            loadSource: async () => (await import('./typeGpuMonocularLightInjection.ts?raw')).default,
        }],
    async mount(context) {
        const [example, { Pane }] = await Promise.all([import('../../../examples/typegpu-monocular-light-injection/src/index.ts'), import('tweakpane')]);
