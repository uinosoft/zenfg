...
export const typeGpuSlimeMoldExample: PlaygroundExampleDefinition = {
	...
	sourceFiles: [
		{
			...
			path: 'apps/site/examples/typegpu-slime-mold/src/main.ts',
			loadSource: async () => (await import('../../../examples/typegpu-slime-mold/src/main.ts?raw')).default,
		},
		{
			id: 'typegpu-slime-mold',
			label: 'slimeMold.ts',
			path: 'apps/site/examples/typegpu-slime-mold/src/slimeMold.ts',
			role: 'example',
			language: 'typescript',
		...
		},
		{
			...
			path: 'apps/site/examples/typegpu-slime-mold/src/types.ts',
			loadSource: async () => (await import('../../../examples/typegpu-slime-mold/src/types.ts?raw')).default,
		},
		{
			id: 'typegpu-slime-mold-host',
			label: 'host.ts',
			path: 'apps/site/examples/typegpu-slime-mold/src/host.ts',
			role: 'host',
			language: 'typescript',
		...
		},
		{
			...
			path: 'apps/site/playground/src/catalog/typeGpuSlimeMold.ts',
			role: 'host',
			language: 'typescript',
	...
	async mount(context) {
		const [{ startTypeGpuSlimeMold }, { Pane }] = await Promise.all([
			import('../../../examples/typegpu-slime-mold/src/index.ts'),
			import('tweakpane'),
		]);
