 ...
 * Demonstrates: Streaming LOD with shared depth and external rendering.
...
export async function startPlayCanvasGsplatStreamingInterop(canvas: HTMLCanvasElement, options: StartSplatOptions = {}): Promise<SplatController | undefined> {
    const label = 'playcanvas-gsplat-streaming-interop';
