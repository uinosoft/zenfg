// @ts-nocheck -- unplugin-typegpu rewrites TypeGPU shader operator syntax during Vite builds.
...
export function createDepthDispatches(
  ...
  return {
    ...
    ownedResources: ctx.ownedResources,
    uniformBuffers: ctx.uniformBuffers,
    mutableStorageBuffers: ctx.mutableStorageBuffers,
    readonlyStorageBuffers: ctx.readonlyStorageBuffers,
  };
}
