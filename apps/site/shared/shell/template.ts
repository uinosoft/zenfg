...
export type SitePage = 'home' | 'inspector' | 'examples';
...
export function renderSiteHeader(page: SitePage): string {
	...
	<div class="site-header-actions">
		...
		<button class="site-control site-theme-toggle project-theme-control" type="button" data-theme-toggle aria-label="Switch to light theme">Theme</button>
