...
export const typeGpuMonocularLightInjectionExample: PlaygroundExampleDefinition = {
    ...
    description: "Estimate depth from an image and add an interactive light with TypeGPU. Inspect the dependency between depth inference and relighting, and how cached depth is reused.",
    instructions: 'Move or drag the light · Scroll to change distance',
