...
try {
    ...
    const smokeTest = [
        ...
        "import { tokyoNightLight } from '@zenfg/inspector/theme'",
        "import { readFileSync } from 'node:fs'",
        "if (tokyoNightLight.colorScheme !== 'light') throw new Error('Inspector theme import failed')",
        "if (!readFileSync(new URL(import.meta.resolve('@zenfg/inspector/themes.css')), 'utf8').includes('data-zfgi-theme')) throw new Error('Inspector CSS preset missing')",
    ...
    writeFileSync(join(consumerDirectory, 'index.ts'), [
        ...
        "import { tokyoNightLight, type InspectorTheme } from '@zenfg/inspector/theme';",
        "const theme: InspectorTheme = { ...tokyoNightLight, variables: { ...tokyoNightLight.variables, '--zfgi-accent': '#2959aa' } };",
