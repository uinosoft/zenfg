...
| [`snapshot-export.ts`](./snapshot-export.ts) | Matching compilation, timing, and pool reports encoded as canonical Snapshot 1.2 JSON for caller-owned download or storage |
...
[Choosing resource declaration granularity](https://github.com/uinosoft/zenfg/blob/npm/webgpu/v0.1.0/docs/core-concepts.md#choosing-resource-declaration-granularity).
