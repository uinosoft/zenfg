...
.zenfg-inspector-memory-summary span { color: var(--fgd-muted); font: 12px/1.4 var(--fgd-font-ui); }
.zenfg-inspector-memory-summary strong { font-size: 13px; white-space: normal; overflow-wrap: anywhere; }
.zenfg-inspector-memory-note { margin: 0; padding: 6px 12px; font: 12px/1.45 var(--fgd-font-ui); }
.zenfg-inspector-memory-timeline { align-content: start; grid-template-columns: minmax(0, 1fr); min-width: 720px; font-size: 12px; }
...
.zenfg-inspector-memory-axis { min-height: 36px; z-index: 4; font-size: 12px; }
...
.zenfg-inspector-memory-axis-track > span { transform: translateX(-50%); border-left: 0; font-size: 11px; }
.zenfg-inspector-memory-gridline { position: absolute; height: 100%; top: 0; border-left: 1px dotted var(--fgd-border-strong); }
.zenfg-inspector-memory-resource { min-height: 36px; }
.zenfg-inspector-memory-name { display: flex; align-items: center; min-height: 36px; gap: 6px; min-width: 0; }
...
.zenfg-inspector-memory-reveal { flex: 0 0 auto; padding: 2px 4px; border: 1px solid var(--fgd-border); border-radius: 3px; color: var(--fgd-text-secondary); background: var(--fgd-panel); font: 11px/1.4 var(--fgd-font-ui); cursor: pointer; }
...
.zenfg-inspector-memory-allocation > span { min-width: 0; overflow-wrap: anywhere; font-size: 12px; }
